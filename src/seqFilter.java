...
public class seqFilter{
   /**
   *main function which reads the input file to make an input array which is filtered sequentially and this process is timed
   *the output is than written to a file
   *@param args input file na,e. filter size and output file name
   */
